...
parser.add_argument('--volume_path', type=str,
                    default='/data/seg/Synapse', help='root dir for data')
parser.add_argument('--num_classes', type=int,
                    default=9, help='output channel of network')
parser.add_argument('--load_checkpoint', type=str,
                    default=r"./outputs/out21/best_train_model.pth", help='output channel of network')
parser.add_argument('--list_dir', type=str,
                    default='./lists/lists_Synapse', help='list dir')
parser.add_argument('--dataset', type=str,
                    default='Synapse', help='dataset_name')
parser.add_argument('--cfg', type=str, default="./configs/synapse_base.yaml", metavar="FILE",
...
def inference(args, model, test_save_path=None):
    ...
    for i_batch, sampled_batch in tqdm(enumerate(testloader)):
        ...
        args.logger.info('idx %d case %s mean_dice %f mean_hd95 %f' % (
...
if __name__ == "__main__":
    ...
    save_dir = os.path.join("/".join(args.load_checkpoint.split("/")[:-1]), "predictions")
    ...
    net = E_SegNet_2D(model_name=config.MODEL.PRETRAIN_MODEL, image_size=args.img_size, num_classes=args.num_classes).cuda()

    msg = net.load_state_dict(torch.load(args.load_checkpoint))
