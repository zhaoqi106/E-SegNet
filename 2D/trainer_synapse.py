...
from datasets.dataset_synapse import Synapse_dataset, RandomGenerator, RandomGenerator2
...
def trainer_synapse(args, model, snapshot_path):
    ...
    db_train = Synapse_dataset(base_dir=args.root_path, list_dir=args.list_dir, split="train",
                               transform=transforms.Compose(
                                   [RandomGenerator(output_size=[args.img_size, args.img_size])]), is_trans=True,
                               transform2=transforms.Compose(
                                   [RandomGenerator2(output_size=[args.img_size, args.img_size])]))
    ...
    for epoch_num in iterator:
        ...
        # if epoch_num >= int(max_epoch * 0.9) - 1:
        #     trainloader.dataset.is_trans = False
