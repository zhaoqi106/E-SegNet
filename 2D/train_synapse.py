...
parser.add_argument('--cfg', type=str, default="./configs/synapse_base.yaml",
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename=args.output_dir + "/log.txt", level=logging.DEBUG,
    ...
    input_tensor = torch.randn(1, 3, args.img_size,args.img_size).cuda()
