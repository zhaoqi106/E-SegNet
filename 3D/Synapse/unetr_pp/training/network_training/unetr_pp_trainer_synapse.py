...
from .swin_3d_E_Net import Swin3dENet as swin_3d
...
class unetr_pp_trainer_synapse(Trainer_synapse):
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, fp16=False,model_name="Video_SwinT_ENet"):
    ...
    def initialize_network(self):
        ...
        :return:
        """
        if self.model_name =="Video_SwinT_ENet":

            self.network = swin_3d(model_name="swin_tiny_patch244_window877_kinetics400_1k",image_size=(64, 128, 128),num_class=self.num_classes)
    ...
    def initialize_optimizer_and_scheduler(self):
        ...
        self.optimizer=torch.optim.AdamW(self.network.parameters(), eps=1e-8, betas=(0.9, 0.999),
                    lr=self.initial_lr, weight_decay=0.00001,)
