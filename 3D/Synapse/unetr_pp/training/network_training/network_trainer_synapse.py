...
class NetworkTrainer_synapse(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        self.lr_threshold = 1e-7  # the network will not terminate training if the lr is still above this threshold
    ...
    def load_checkpoint_ram(self, checkpoint, train=True):
        ...
        if isinstance(self.network, torch.nn.DataParallel) and list(new_state_dict)[0].split(".")[0] !="module":
